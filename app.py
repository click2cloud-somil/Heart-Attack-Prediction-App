...
def main():
    ...
    SerumCreatinine = st.slider("Enter Level of serum creatinine in the blood [mg/dL]",min_value=0.5, max_value=2.5)
    SerumSodium = st.slider("Enter Level of serum sodium in the blood [mEq/L]",min_value=125.0,max_value=150.0)
